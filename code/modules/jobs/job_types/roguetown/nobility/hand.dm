...
/datum/job/roguetown/hand
	...
	tutorial = "Ты - верный рыцарь и ближайший советник своего лорда. Вместе с ним мы прошли не одну битву, посетили не один дворец и у вас нет причин не доверять друг другу. Ты дал клятву вечного служения во славу своего лорда, т.к. именно он вывел тебя в дворяне из грязи и ты обязан ему жизнью."
